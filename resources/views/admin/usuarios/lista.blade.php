        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    Lista de usuários
                    <a href="{{ url('usuarios/create') }}" class="btn btn-success btn-sm float-right">Novo Usuário</a>
                </div>
                        ...
                        <tbody>
                            @foreach ($usuarios as $usuario)
                                <tr>
                                    ...
                                    <td>{{ $usuario->email }}</td>
                                    <td>
                                        <a href="{{ url('usuarios/'.$usuario->id) }}" class="btn btn-primary btn-sm">Editar</a>
