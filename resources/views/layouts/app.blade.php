                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        @auth
                            ...
                            <li class="nav-item">
                                <a href="{{ url('noticias') }}" class="nav-link">Notícias</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('fotos') }}" class="nav-link">Galeria de fotos</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('links') }}" class="nav-link">Links Úteis</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('infos') }}" class="nav-link">Mais Informações</a>
                            </li>
                            <li class="nav-item">
